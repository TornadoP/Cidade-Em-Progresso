...
export default function HomeClient({ obras }: { obras: Obra[] }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-[#425C59] to-[#CBDfde] p-4 font-sans sm:p-6">
      <GuiaInicial />

      <main className="flex w-full max-w-5xl flex-col overflow-hidden rounded-3xl bg-[#425C59] shadow-[0_25px_80px_rgba(0,0,0,0.45)] md:min-h-[650px] md:flex-row">
