        ...
        <section className="flex flex-1 flex-col px-4 py-6 sm:px-6 md:px-10 md:py-8">
          <div className="mx-auto flex w-full max-w-[662px] flex-1 flex-col">
            ...
            <div className="flex flex-1 flex-col items-stretch justify-center gap-6 lg:flex-row lg:gap-8">
              {/* Card principal */}
              <div className="w-full rounded-3xl bg-[#425C59] p-5 shadow-[0_25px_60px_rgba(0,0,0,0.45)] ring-1 ring-white/20 transition-all duration-300 hover:-translate-y-2 hover:scale-[1.01] hover:shadow-[0_35px_80px_rgba(0,0,0,0.55)] lg:w-[420px]">
                {/* Área da imagem */}
              ...
              {/* Outras Obras */}
              <div className="flex w-full flex-col rounded-3xl bg-[#425C59] p-5 shadow-[0_25px_60px_rgba(0,0,0,0.45)] ring-1 ring-white/20 transition-all duration-300 hover:-translate-y-2 hover:scale-[1.01] hover:shadow-[0_35px_80px_rgba(0,0,0,0.55)] lg:w-[210px]">
